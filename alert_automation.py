...
def send_alert(mismatches):
    ...
    # Adding a sense of urgency to the subject
    ...
    # Get current time and hostname for the footer

    now = datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")

    hostname = "ubu-01" # Or use socket.gethostname()
        ...
        <div style="max-width: 650px; margin: auto; background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 10px 25px rgba(0,0,0,0.1); border: 1px solid #e1e4e8;">
            ...
            <div style="padding: 30px;">
                ...
                <p style="font-size: 15px; line-height: 1.6; color: #555;">
                    ...
                    The automated scan on <strong>{hostname}</strong> has identified versions that are behind the latest vendor releases. Please review the table below for the recommended upgrade paths.
    ...
    html += f"""
                ...
                <div style="margin-top: 30px; padding: 20px; background-color: #f0f7ff; border-radius: 8px; border-left: 4px solid #004a99;">
                    ...
                    <ul style="margin: 10px 0 0; padding-left: 20px; font-size: 13px; color: #475569;">
                        ...
                        <li>Download updates from the official vendor portal.</li>

                        <li>Schedule a maintenance window for deployment.</li>
